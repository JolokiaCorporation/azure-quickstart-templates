...
disk_format() {
	...
	for ((j=1;j<=3;j++))
	do
		wget https://raw.githubusercontent.com/JolokiaCorporation/azure-quickstart-templates/master/shared_scripts/ubuntu/vm-disk-utils-0.1.sh
